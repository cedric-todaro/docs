...
\begin{itemize}
	\item $f$ admet un \textbf{minimum} en $x_0$ sur $\intff{a}{b}$ si pour tout $x\in\intff{a}{b}$, on a : $$f(x)\ge f(x_0)$$
	\item $f$ admet un \textbf{maximum} en $x_0$ sur $\intff{a}{b}$ si pour tout $x\in\intff{a}{b}$, on a : $$f(x)\le f(x_0)$$
\end{itemize}
...
\begin{itemize}
	...
	\item Solutions de $f(x)\ge -x+3$ : $[0\,;\,5]$.
	\item Solutions de $f(x)>2$ : $\left]-1\,;\,2\right[$.
\end{itemize}

% TODO: prop [signe d'une fonction] --> Tableau de signe et exemple
...
% TODO: Étude du signe et tableau de signe 
