...
\begin{multicols}{2}
	...
	\begin{exo}{}
		...
		\textbf{1.} Déterminer les équations réduites des droites $(AK)$
		et $(BJ)$.

		\textbf{2.} En déduire les coordonnées de leur point
		d'intersection $G$.

		\textbf{3.} Démontrer que $G$ appartient également à la droite
		$(CI)$.
	\end{exo}
